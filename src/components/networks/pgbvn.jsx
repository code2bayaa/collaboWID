// import slide15 from "../assets/home/HEALTH.jpg"
// import career2 from "../../assets"
        ...
        <div className = "component">
            ...
            <div id="health" className="inner-component">
                        <div className = "headers-line"><div className="education-left"></div><h1>Networks</h1><div className="education-right"></div></div>
                            <section>
                                <img src={networks.length > 0 ? networks[0].img : ""} alt="web developers https://late-developers.com" className='homeFrame' loading="lazy"/>
                                {networks.length > 0 ? parse(networks[0].body) : ""}    
