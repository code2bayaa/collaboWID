        ...
        <div className = "component">
            ...
            <div id="health" className="inner-component">
                        <div className = "headers-line"><div className="education-left"></div><h1>Networks</h1><div className="education-right"></div></div>
                            <section>
                                <img src={networks.length > 2 ? networks[2].img : ""} alt="web developer late developer https://late-developers.com" className='homeFrame' loading="lazy"/>
                                {networks.length > 2 ? parse(networks[2].body) : ""}
                            </section>
                        </div>
                        <Footer/>
            </div>
