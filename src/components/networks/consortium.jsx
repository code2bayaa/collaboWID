        ...
        <div className = "component">
            ...
            <div id="health" className="inner-component">
                        <div className = "headers-line"><div className="education-left"></div><h1>Networks</h1><div className="education-right"></div></div>
                            <section>
                                <img src={networks.length > 10 ? networks[10].img : ""} alt="web developers late developers https://late-developers.com" className='homeFrame' loading="lazy"/>
                                {networks.length > 10 ? parse(networks[10].body) : ""}
                            </section>
                        </div>
                        <Footer/>
            </div>
